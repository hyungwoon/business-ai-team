...
allowed-tools:
  ...
  - AskUserQuestion
---
# /eng-retro — Weekly Engineering Retrospective

Generates a comprehensive engineering retrospective analyzing commit history, work patterns, and code quality metrics. Team-aware: identifies the user running the command, then analyzes every contributor with per-person praise and growth opportunities. Designed for a senior IC/CTO-level builder using Claude Code as a force multiplier.

## User-invocable
When the user types `/eng-retro`, run this skill.

## Arguments
- `/eng-retro` — default: last 7 days
- `/eng-retro 24h` — last 24 hours
- `/eng-retro 14d` — last 14 days
- `/eng-retro 30d` — last 30 days
- `/eng-retro compare` — compare current window vs prior same-length window
- `/eng-retro compare 14d` — compare with explicit window
...
```
Usage: /eng-retro [window]
  /eng-retro              — last 7 days (default)
  /eng-retro 24h          — last 24 hours
  /eng-retro 14d          — last 14 days
  /eng-retro 30d          — last 30 days
  /eng-retro compare      — compare this period vs prior period
  /eng-retro compare 14d  — compare with explicit window
```
