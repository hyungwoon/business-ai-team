...
`.omc/telemetry/{YYYY-MM-DD}.jsonl`
...
```json
{
  ...
  "metadata": {
    ...
    "duration_ms": 120000,
    "model_used": "sonnet",
    "mode": "autopilot | ralph | ultrawork | standalone"
  },
...
`/eng-retro` 스킬 실행 시 텔레메트리 분석을 추가한다:
...
4. **모드별 성공률**: autopilot/ralph/ultrawork/standalone별 비교
...
- **feedback-learning.md**: 사용자 피드백 → user_feedback 점수
- **eng-retro 스킬**: 주간 텔레메트리 분석 보고서 생성
