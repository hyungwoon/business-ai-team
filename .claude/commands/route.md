---
description: 비즈니스 + 엔지니어링 요청을 전문가 에이전트 또는 네이티브 스킬에 라우팅합니다.
---
...
**복합 요청**: A와 B 모두 해당하면 둘 다 활성화. 예: "PRD 작성하고 코드 리뷰해줘" → Product 에이전트 + review 네이티브 스킬

복합 비즈니스 요청이면 여러 에이전트도 식별한다.
...
- `> **담당**: Engineering | 참조 스킬: review`
- `> **담당**: Product + Engineering | 참조 스킬: create-prd, review`
