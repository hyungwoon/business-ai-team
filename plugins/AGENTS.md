...
17 domain plugins containing 110+ skills. 10 from Anthropic knowledge-work-plugins, 7 custom-built. product-management expanded to 63 skills (including competitor-analysis merge) via PM Skills (Paweł Huryn) Korean edition. Plugin skills are also available as native mega-skills via `.claude/skills/` for Claude Code auto-discovery.
